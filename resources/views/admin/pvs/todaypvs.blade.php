...
<div class="row wrapper border-bottom white-bg page-heading">
    <div class="col-lg-12">
        <h2 class="font-weight-bold">Today PVs <a href="{{ route('new.customer') }}" class="float-right btn btn-sm btn-primary">New Customer</a></h2>
    </div>
</div>
                ...
                @foreach($orders as $order)
                    <tr>
                        ...
                        <td class="center">
                            ...
                            <a href="{{ route('show.order',$order->id) }}" class="btn btn-sm btn-primary">Invoice</a>
                        </td>
                    </tr>
                @endforeach
                </tbody>
