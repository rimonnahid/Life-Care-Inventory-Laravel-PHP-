...
<div class="row wrapper border-bottom white-bg page-heading">
    <div class="col-lg-12">
        <h3 class="font-weight-bold mt-3">Orders List <a href="{{ route('new.employee') }}" class="btn btn-sm btn-primary float-right">New orders</a></h3>
    </div>
</div>
                    ...
                    <tr class="gradeX">
                      ...
                      {{--       @elseif($order->status == 2)
                        ...
                        <td class="center">
                            ...
                            <a href="{{ route('delete.order',$order->id) }}" class="btn btn-danger btn-sm" id="delete"><i class="fa fa-trash-o"></i></a>
                            @endif
                        </td>
                    </tr>
                @endforeach
