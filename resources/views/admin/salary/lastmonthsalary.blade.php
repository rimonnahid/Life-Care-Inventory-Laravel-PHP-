...
<div class="row wrapper border-bottom white-bg page-heading">
    <div class="col-lg-12">
        <h2 class="font-weight-bold">Salary Payment List (Last Month: <span class="text-secondary">{{ date('F',strtotime('-1 month')) }}</span>) <a href="{{ route('new.salary') }}" class="float-right btn btn-primary btn-sm">New Salary pay</a></h2>
    </div>
</div>
