		...
		<div class="row">
			<div class="col-md-6">
				<div class="form-group">
					<label>Name</label>
					<input type="text" class="form-control" value="{{ old('name') }}" name="name" placeholder="enter customer name" required="">
				</div>
				<div class="form-group">
					<label>Email</label>
					<input type="text" class="form-control" value="{{ old('name') }}" name="email" placeholder="enter customer email">
				</div>
				{{-- <div class="form-group">
			...
			<div class="col-md-6">
				...
				<div class="form-group">
					...
					<input type="tel" class="form-control" value="MEM-" name="cus_id" placeholder="enter customer id" required="">
				</div>
				<div class="form-group">
					<label>Gender</label>
				...
				<div class="form-group">
					<label>Phone</label>
					<input type="tel" class="form-control" value="{{ old('phone') }}" name="phone" placeholder="enter customer phone" required="">
				</div>
			{{-- 	<div class="form-group">
			...
			<button type="submit" class="btn btn-primary btn-block col-md-12">Join New Customer</button>
		</div>
	</form>
</div>
